...
@ViewDeclaration( id = Charging81ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Charging81View.fxml", type = ViewType.MAIN )
public class Charging81ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.CHARGING_81.VIEW;
    ...
    void initialize()
    {
        chargingController.initialize( Casting.MACHINE.MELTING_FURNACE_81 );
    }
