...
@ViewDeclaration( id = MaBe50ViewController.ID, fxmlFile = "/com/hydro/casting/gui/planning/view/MaBe50View.fxml", type = ViewType.MAIN )
public class MaBe50ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.MABE.CASTER_50.VIEW;
    ...
    void initialize()
    {
        maBeController.initialize( Casting.MACHINE.CASTER_50, injector );
    }
