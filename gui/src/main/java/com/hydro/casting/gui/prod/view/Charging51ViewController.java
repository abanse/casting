...
@ViewDeclaration( id = Charging51ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Charging51View.fxml", type = ViewType.MAIN )
public class Charging51ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.CHARGING_51.VIEW;
    ...
    void initialize()
    {
        chargingController.initialize( Casting.MACHINE.MELTING_FURNACE_51 );
    }
