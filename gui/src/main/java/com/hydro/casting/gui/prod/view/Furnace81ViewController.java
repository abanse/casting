...
@ViewDeclaration( id = Furnace81ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Furnace81View.fxml", type = ViewType.MAIN )
public class Furnace81ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.FURNACE_81.VIEW;
    ...
    void initialize()
    {
        furnaceController.initialize( Casting.MACHINE.MELTING_FURNACE_81 );
    }
