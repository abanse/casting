...
public class DowntimeAddTask extends AbstractTask
{
    @Inject
    ...
    public void doWork() throws Exception
    {
        ...
        DowntimeCreationDTO data = downtimeBusiness.loadEmptyDataDowntime( new String[] { costCenter }, null );
        ...
        notifyManager.showCompWindow( "Störzeit erfassen", downtimeDialog );
    ...
    public String getId()
    {
        return DowntimeConstants.ACTION_ID.ADD;
    }
}
