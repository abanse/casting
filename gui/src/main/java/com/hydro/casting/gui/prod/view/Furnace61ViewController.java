...
@ViewDeclaration( id = Furnace61ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Furnace61View.fxml", type = ViewType.MAIN )
public class Furnace61ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.FURNACE_61.VIEW;
    ...
    void initialize()
    {
        furnaceController.initialize( Casting.MACHINE.MELTING_FURNACE_61 );
    }
