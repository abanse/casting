...
@ViewDeclaration( id = Charging62ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Charging62View.fxml", type = ViewType.MAIN )
public class Charging62ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.CHARGING_62.VIEW;
    ...
    void initialize()
    {
        chargingController.initialize( Casting.MACHINE.MELTING_FURNACE_62 );
    }
