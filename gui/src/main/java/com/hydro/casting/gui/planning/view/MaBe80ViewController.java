...
@ViewDeclaration( id = MaBe80ViewController.ID, fxmlFile = "/com/hydro/casting/gui/planning/view/MaBe80View.fxml", type = ViewType.MAIN )
public class MaBe80ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.MABE.CASTER_80.VIEW;
    ...
    void initialize()
    {
        maBeController.initialize( Casting.MACHINE.CASTER_80, injector );
    }
