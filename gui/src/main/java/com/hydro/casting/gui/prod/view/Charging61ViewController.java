...
@ViewDeclaration( id = Charging61ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Charging61View.fxml", type = ViewType.MAIN )
public class Charging61ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.CHARGING_61.VIEW;
    ...
    void initialize()
    {
        chargingController.initialize( Casting.MACHINE.MELTING_FURNACE_61 );
    }
