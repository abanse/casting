...
@ViewDeclaration( id = Caster80ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Caster80View.fxml", type = ViewType.MAIN )
public class Caster80ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.CASTER_80.VIEW;
    ...
    void initialize()
    {
        casterController.initialize( Casting.MACHINE.CASTER_80 );
    }
