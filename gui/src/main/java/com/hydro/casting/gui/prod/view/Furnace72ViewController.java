...
@ViewDeclaration( id = Furnace72ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Furnace72View.fxml", type = ViewType.MAIN )
public class Furnace72ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.FURNACE_72.VIEW;
    ...
    void initialize()
    {
        furnaceController.initialize( Casting.MACHINE.MELTING_FURNACE_72 );
    }
