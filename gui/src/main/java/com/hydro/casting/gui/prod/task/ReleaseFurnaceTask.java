...
public class ReleaseFurnaceTask extends AbstractMultiSelectTask<CasterScheduleDTO>
{
    @Inject
    ...
    public String getId()
    {
        return SecurityCasting.PROD.ACTION.RELEASE_FURNACE;
    }
    ...
    public boolean beforeStart() throws Exception
    {
        ...
        stepTimestampResult = StepTimestampDialog.showDialog( "Ofen " + FurnaceStep.ReadyToCast.getDescription(), lastStepStartTS );
    ...
    public void doWork() throws Exception
    {
        ...
        productionBusiness.releaseFurnace( securityManager.getCurrentUser(), machine, furnaceInstructionDTO.getCastingBatchOID(), stepTimestampResult.getStepTime() );

        notifyManager.showSplashMessage( "Start " + FurnaceStep.ReadyToCast.getDescription() + " wurde gebucht" );
    }
}
