...
import com.hydro.casting.gui.prod.control.AnalysisDetailController;
...
public class MeltingProcessDocuDetailController extends DetailTabsController<MeltingProcessDocuDTO>
{
    @FXML
    ...
    private final Callback<MeltingProcessDocuDTO, ProcessDocuDTO> processDocuConverter = meltingProcessDocuDTO -> {
        final ProcessDocuDTO processDocuDTO = new ProcessDocuDTO( meltingProcessDocuDTO.getId() );
        processDocuDTO.setCharge( meltingProcessDocuDTO.getCharge() );
    ...
    protected void initialize()
    {
        ...
        registerDetail( analysisDetail, analysisDetailController, processDocuConverter );
    ...
    @Override
    protected void setTitle( MeltingProcessDocuDTO viewDTO )
    {
        if ( viewDTO == null )
        {
