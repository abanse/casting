...
import com.hydro.casting.gui.stock.detail.StockMaterialDetailController;
...
@ViewDeclaration( id = StockMaterialViewController.ID, fxmlFile = "/com/hydro/casting/gui/stock/view/StockMaterialView.fxml", type = ViewType.MAIN )
public class StockMaterialViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.STOCK.STOCK_MATERIAL.VIEW;
    @Inject
    ...
    @FXML
    private StockMaterialDetailController detailsController;
