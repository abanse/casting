...
@ViewDeclaration( id = Charging71ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Charging71View.fxml", type = ViewType.MAIN )
public class Charging71ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.CHARGING_71.VIEW;
    ...
    void initialize()
    {
        chargingController.initialize( Casting.MACHINE.MELTING_FURNACE_71 );
    }
