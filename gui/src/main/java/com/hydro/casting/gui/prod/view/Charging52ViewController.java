...
@ViewDeclaration( id = Charging52ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Charging52View.fxml", type = ViewType.MAIN )
public class Charging52ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.CHARGING_52.VIEW;
    ...
    void initialize()
    {
        chargingController.initialize( Casting.MACHINE.MELTING_FURNACE_52 );
    }
