...
public class CleanFurnaceTask extends AbstractMultiSelectTask<CasterScheduleDTO>
{
    @Inject
    ...
    public String getId()
    {
        return SecurityCasting.PROD.ACTION.CLEAN_FURNACE;
    }
    ...
    public boolean beforeStart() throws Exception
    {
        ...
        stepTimestampResult = StepTimestampDialog.showDialog( "Ofen reinigen", lastStepStartTS );
    ...
    public void doWork() throws Exception
    {
        ...
        productionBusiness.startFurnaceStep( securityManager.getCurrentUser(), machine, furnaceInstructionDTO.getCastingBatchOID(), FurnaceStep.Preparing, stepTimestampResult.getStepTime() );

        notifyManager.showSplashMessage( "Start Ofenreinigung wurde gebucht" );
    }
}
