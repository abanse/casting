...
@ViewDeclaration( id = Furnace52ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Furnace52View.fxml", type = ViewType.MAIN )
public class Furnace52ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.FURNACE_52.VIEW;
    ...
    void initialize()
    {
        furnaceController.initialize( Casting.MACHINE.MELTING_FURNACE_52 );
    }
