...
@ViewDeclaration( id = Charging72ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Charging72View.fxml", type = ViewType.MAIN )
public class Charging72ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.CHARGING_72.VIEW;
    ...
    void initialize()
    {
        chargingController.initialize( Casting.MACHINE.MELTING_FURNACE_72 );
    }
