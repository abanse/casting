package com.hydro.casting.gui.fernladung.view;
...
@ViewDeclaration( id = LegierungsDatenViewController.ID, fxmlFile = "/com/hydro/casting/gui/fernladung/view/LegierungsDatenView.fxml", type = ViewType.MAIN )
public class LegierungsDatenViewController extends ViewControllerBase
{
