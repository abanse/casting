...
@ViewDeclaration( id = Caster50ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Caster50View.fxml", type = ViewType.MAIN )
public class Caster50ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.CASTER_50.VIEW;
    ...
    void initialize()
    {
        casterController.initialize( Casting.MACHINE.CASTER_50 );
    }
