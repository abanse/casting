...
@ViewDeclaration( id = Furnace62ViewController.ID, fxmlFile = "/com/hydro/casting/gui/prod/view/Furnace62View.fxml", type = ViewType.MAIN )
public class Furnace62ViewController extends ViewControllerBase
{
    public final static String ID = SecurityCasting.PROD.FURNACE_62.VIEW;
    ...
    void initialize()
    {
        furnaceController.initialize( Casting.MACHINE.MELTING_FURNACE_62 );
    }
