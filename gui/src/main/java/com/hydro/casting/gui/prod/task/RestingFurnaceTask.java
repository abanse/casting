...
public class RestingFurnaceTask extends AbstractMultiSelectTask<CasterScheduleDTO>
{
    @Inject
    ...
    public String getId()
    {
        return SecurityCasting.PROD.ACTION.RESTING_FURNACE;
    }
    ...
    public boolean beforeStart() throws Exception
    {
        ...
        stepTimestampResult = StepTimestampDialog.showDialog( "Ofen " + FurnaceStep.Resting.getDescription(), lastStepStartTS );
    ...
    public void doWork() throws Exception
    {
        ...
        productionBusiness.startFurnaceStep( securityManager.getCurrentUser(), machine, furnaceInstructionDTO.getCastingBatchOID(), FurnaceStep.Resting, stepTimestampResult.getStepTime() );

        notifyManager.showSplashMessage( "Start " + FurnaceStep.Resting.getDescription() + " wurde gebucht" );
    }
}
